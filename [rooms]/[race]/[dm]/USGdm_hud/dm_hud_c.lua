...
addEventHandler("onClientResourceStart", resourceRoot,
    function ()
        if(getResourceFromName("USGrooms") and getResourceState(getResourceFromName("USGrooms")) == "running" and exports.USGrooms:getPlayerRoom() == "dm") then
            resetFade(2000)
...
function renderPlayers()
    ...
    for i, player in ipairs(getElementsByType("player", root, true)) do
        if(isElementStreamedIn(player) and exports.USGrooms:getPlayerRoom(player) == "dm" and isPedInVehicle(player)) then
