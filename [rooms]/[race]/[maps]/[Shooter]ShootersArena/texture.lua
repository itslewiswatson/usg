function onResourceStart()
	...
	engineImportTXD ( TXD, 9623 )
	engineImportTXD ( TXD, 3489 )
	engineImportTXD ( TXD, 3256 )
	engineImportTXD ( TXD, 8150 )
	engineImportTXD ( TXD, 4602 )
	engineImportTXD ( TXD, 4832 )
	engineImportTXD ( TXD, 11484 )
	engineImportTXD ( TXD, 1655 )
	engineImportTXD ( TXD, 4990 )
	engineImportTXD ( TXD, 9131 )
	engineImportTXD ( TXD, 3457 )
	engineImportTXD ( TXD, 3865 )
