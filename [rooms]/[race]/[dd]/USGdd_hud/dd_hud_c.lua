...
addEventHandler("onClientResourceStart", resourceRoot,
    function ()
        if(getResourceFromName("USGrooms") and getResourceState(getResourceFromName("USGrooms")) == "running" and exports.USGrooms:getPlayerRoom() == "dd") then
            resetFade(2000)
...
function renderPlayers()
    ...
    for i, player in ipairs(getElementsByType("player", root, true)) do
        if(exports.USGrooms:getPlayerRoom(player) == "dd" and isPedInVehicle(player)) then
