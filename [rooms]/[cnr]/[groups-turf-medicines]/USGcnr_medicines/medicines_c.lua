...
local screenW, screenH = guiGetScreenSize()
    ...
    medicinesGUI.amount = guiCreateEdit(9, y+30, 111, 22, "", false,medicinesGUI.window)
    medicinesGUI.take = guiCreateButton(137, y+30, 66, 28, "Take", false,medicinesGUI.window)
