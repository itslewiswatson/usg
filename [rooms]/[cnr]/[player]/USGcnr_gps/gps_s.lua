...
addEvent("USGcnr_gps.calculatePathByCoords", true)
...
addEventHandler("USGcnr_gps.calculatePathByCoords", root,
	function (...)
		local path = calculatePathByCoords(...)
		triggerClientEvent(client, "USGcnr_gps.pathCalculated", client, path)
	end
)
