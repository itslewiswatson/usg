...
function createShops()
    ...
    createBlip ( 1368.35, -1279.06, 12.55, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( -2625.85, 208.345,3.98935, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( 242.668, -178.478, 0.621441, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( 2333.43, 61.5173, 25.7342, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( 2159.51, 943.329, 9.82339, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( 2539.04, 2083.56, 9.82222, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( 777.231, 1871.47, 3.97687, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( -315.676, 829.868, 13.4266, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( -2093.51, -2464.79, 29.6404, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( 2400.5, -1981.48, 12.5604, 6, 2, 0, 0, 0, 0, 0, 270 )
    createBlip ( -1508.95, 2608.75, 55.83, 6, 2, 0, 0, 0, 0, 0, 270 )
end
