...
function skin.drawElement(element,x,y,disabled, hovered)
    ...
    elseif info.guiType == "window" then
       ...
       -- dxDrawLine(x,y,x+info.width,y,tocolor(0,0,0,250),3,post_gui)
        dxDrawLine(x-1,y,x-1,y+info.height,tocolor(175,75,0,250),3,post_gui)
        dxDrawLine(x,y+info.height,x+info.width,y+info.height,tocolor(175,75,0,250),3,post_gui)
        dxDrawLine(x+info.width,y,x+info.width,y+info.height,tocolor(175,75,0,250),3,post_gui)
        else
        titleColor =  tocolor(175,75,0, 200)
...
skin.defaultColors = {
    selection = tocolor(175,75,0,210),
    hover = tocolor(180,80,0,215),
    window = tocolor(0,0,0,190),
    ...
    tabpanel_header = tocolor(33,21,3,220),
