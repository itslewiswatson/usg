...
addEvent("onUSGChat")
function onChat(msg, msgType, fullMsg, ircColored)
	local room = exports.USGrooms:getPlayerRoom(source) or "LOBBY"
	ircColored = "14["..room:upper().."] "..ircColored
	outputIRC(ircColored)
end
addEventHandler("onUSGChat", root, onChat)
--[[
