local img1 = dxCreateTexture("images/account_icon.png")
local img2 = dxCreateTexture("images/call_icon.png")
local img3 = dxCreateTexture("images/gps_icon.png")
local img4 = dxCreateTexture("images/messages_icon.png")
local img5 = dxCreateTexture("images/money_icon.png")
local img6 = dxCreateTexture("images/music_icon.png")
local img7 = dxCreateTexture("images/weapons_icon.png")
